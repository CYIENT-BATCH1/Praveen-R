...
void main(void) {
    ...
    char Rx_Instrument_Cluster_Warning_Lamp;
    ...
    {       
       ...
       /* Rx_Occupant_Classification_Warning_Lamp = 0x00;//(ReadfromEEPROM[10]>>2)&0x0F;
        Rx_Instrument_Cluster_Warning_Lamp = 0x00;//(SWStatus[1]<<1) | SWStatus[0];//Trip Reset Switch Status
        */
